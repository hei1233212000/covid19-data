...
The https://covid19.who.int/page-data/table/page-data.json[COVID-19 data,window=_blank] is from https://www.who.int/[WHO,window=_blank].
However, WHO restricts its data by using CORS, so I also use the https://cors-anywhere.herokuapp.com/[CORS Anywhere,window=_blank] to bypass CORS.
